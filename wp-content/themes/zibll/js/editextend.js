(function ($, window) {
    ...
    zib.media = function (args) {
        ...
        this.createImageList = function (data) {
            return '<img src="' + (data.thumbnail_url || '') + '" data-full-url="' + (data.url || '') + '" alt="' + (data.title || this.type) + '">';
        };
            ...
            switch (this.type) {
                ...
                default:
                    ...
                    switch (data.type) {
                        ...
                        case 'image':
                            icon_html = '<div style="padding-bottom: 100%!important;border-radius: 4px;" class="graphic "><img class="fit-cover" src="' + (data.thumbnail_url || data.url) + '" alt="' + (data.title || 'image') + '"></div>';
                            break;
                    }
